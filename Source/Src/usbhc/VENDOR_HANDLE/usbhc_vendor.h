 ...
 */
/*================================================================================
 * Module Name : usbhc_vendor.h
 * Purpose     : A header file of usbhc_vendor.c, the vendor special handler
 *               handle the special function.
 * Author      : Jack Wang
 * Date        :
 * Notes       :
 * no message
...
#ifndef __USB_HC_VENDOR_H__
#define __USB_HC_VENDOR_H__
...
#endif /* End of __USB_HC_VENDOR_H__ */
/* End of usbhc_vendor.h */